...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Atila Rufo and Ana Carolina`s cadastro',
      theme: ThemeData(
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Atila Rufo e Ana Carolina'),
      ),
      body: Center(
        child: Column(
...
class UpdateDeleteItemPage extends StatelessWidget {
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                ElevatedButton(
                  onPressed: () async {
                    // Implementar a funcionalidade de atualizar o item no banco de dados
                    Navigator.pop(context);
                  },
